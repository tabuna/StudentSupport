    ...
    <div class="wrapper-md">
        ...
        <form class="form-horizontal" method="post" action="{{route('organization.store')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description" class="form-control no-resize" rows="5" required  maxlength="2000" placeholder="Описание"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" class="btn btn-default">Создать организацию</button>
                </div>
            </div>
        </form>
